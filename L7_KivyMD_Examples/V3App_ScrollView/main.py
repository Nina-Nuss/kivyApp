# siehe https://kivymd.readthedocs.io/en/latest/components/scrollview/
import os
import sys
...
class Example(MDApp):#, CommonApp):
    ...
    def open_menu(self,evt_src):
        print("open_menu()",evt_src)

    def on_start(self):
        info = {
            "Name": [sys.platform, "android" if sys.platform.startswith("win") else "linux"],
